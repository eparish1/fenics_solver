...
#RSx,RSy,RSz = eqn.applyJ(U,Ux,Uy,Uz)
#R_strong = [None]*5
#for i in range(0,5):
#  R_strong[i] =  RSx[i] +  RSy[i] +  RSz[i]
R_strongDT = [None]*5
for i in range(0,5):
...
vtkfile_u_0 = File('Sol/u_0.pvd')
#vtkfile_u_1 = File('Sol/u_1.pvd')
...
#                             preconditioner='ilu')})
  ...
  np.savez('energy_galerkin',energy=energy)
